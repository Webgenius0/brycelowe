        ...
        return Inertia::render('dashboard', [
            'stats' => [
                ...
                'period' => [
                    ...
                    'total_revenue' => 0,
                    'pending_payouts' => 0,
                    'total_admins' => User::where('role', 'Admin')->whereBetween('created_at', [$from, $to])->count(),
                    'total_partners' => User::where('role', 'Partner')->whereBetween('created_at', [$from, $to])->count(),
                    'total_customers' => User::where('role', 'User')->whereBetween('created_at', [$from, $to])->count(),
                ],
