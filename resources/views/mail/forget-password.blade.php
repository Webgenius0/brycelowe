...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset the password for your <strong>{{ $systemSetting?->site_name ?? $systemSetting?->site_title ?? config('app.name') }}</strong> account. Please use the verification code below to proceed with resetting your password:</p>
